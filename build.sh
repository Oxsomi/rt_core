...
if ! conan create core3 -s build_type=Release -o forceVulkan=False -o enableSIMD=True -o enableTests=False -o enableOxC3CLI=True -o forceFloatFallback=False -o enableShaderCompiler=True -o cliGraphics=True --build=missing; then
...
if ! conan create core3 -s build_type=Release -o forceVulkan=%3 -o enableSIMD=%2 -o enableTests=False -o enableOxC3CLI=True -o forceFloatFallback=False -o enableShaderCompiler=True -o cliGraphics=True --build=missing; then
